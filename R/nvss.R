	...
	function( data_name = "nvss" , catalog , path_to_7za = '7za' , path_to_winrar = normalizePath( "C:/Program Files/winrar/winrar.exe" ) , ... ){
		...
		for ( i in seq_len( nrow( catalog ) ) ){
			...
			if( catalog[ i , 'type' ] == 'natality' ){
				...
				nchs_download( natality , catalog[ i , 'output_folder' ] , path_to_winrar = path.to.winrar , path.to.7z = path_to_7za )
			...
			if( catalog[ i , 'type' ] == 'periodlinked' ){
				...
				nchs_download( period.linked , catalog[ i , 'output_folder' ] , path_to_winrar = path.to.winrar , path.to.7z = path_to_7za )
			...
			if( catalog[ i , 'type' ] == 'cohortlinked' ){
				...
				nchs_download( cohort.linked , catalog[ i , 'output_folder' ] , path_to_winrar = path.to.winrar , path.to.7z = path_to_7za )
			...
			if( catalog[ i , 'type' ] == 'mortality' ){
				...
				nchs_download( mortality , catalog[ i , 'output_folder' ] , path_to_winrar = path.to.winrar , path.to.7z = path_to_7za )
